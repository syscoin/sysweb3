...
const TrezorConnect = {
  ...
  getDeviceId: () => Promise.resolve({ success: true, payload: { deviceId: 'mock-device-id' } }),
  ...
  ethereumGetAddress: () => Promise.resolve({ 
    success: true, 
  ...
  getAccountInfo: () => Promise.resolve({
    success: true,
    payload: {
      descriptor: 'vpub5YBbnk2FsQPCd4LsK7rESWaGVeWtq7nr3SgrdbeaQgctXBwpFQfLbKdwtDAkxLwhKubbpNwQqKPodfKTwVc4uN8jbsknuPTpJuW8aN1S3nC',
      balance: '0',
      availableBalance: '0',
      empty: false,
      addresses: {
